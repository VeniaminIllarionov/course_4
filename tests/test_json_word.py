...
@pytest.fixture
def json_work():
    json_list = Json_Work('Прокурор')
    return json_list


def test_init(json_work):
    assert json_work.write_file() == [
        {'id': '93513808', 'premium': False, 'name': 'Помощник прокурора (кадровый резерв)', 'department': None,
         ...
         'relations': [], 'employer': {'id': '3128277', 'name': 'Прокуратура Республики Крым',
                                       ...
                                       'logo_urls': {'240': 'https://hhcdn.ru/employer-logo/3430910.png',
                                                     ...
                                                     'original': 'https://hhcdn.ru/employer-logo-original/747487.png'},
