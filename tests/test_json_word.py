...
def test_init2(json_work, req_hh):
    assert json_work.read_file() == [
        {'id': '93513808', 'premium': False, 'name': 'Помощник прокурора (кадровый резерв)', 'department': None,
         ...
         'published_at': '2024-02-20T09:46:47+0300', 'created_at': '2024-02-20T09:46:47+0300', 'archived': False,
         ...
         'url': 'https://api.hh.ru/vacancies/93513808?host=hh.ru', 'alternate_url': 'https://hh.ru/vacancy/93513808',
         'relations': [], 'employer': {'id': '3128277', 'name': 'Прокуратура Республики Крым',
            ...
            'requirement': '1) надзор за соблюдением Конституции РФ и исполнением законов, прав и свобод человека и '
                           'гражданина. - наличие высшего юридического образования по...',
            'responsibility': 'Прокуратурой Республики Крым на систематической основе проводится отбор кандидатов для'
                              ' постановки в кадровый резерв для последующего рассмотрения вопроса приема на...'},
