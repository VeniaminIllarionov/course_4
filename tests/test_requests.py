...
def test_init(requests):
    ...
    assert requests.save_info() == [{'id': '93513808', 'premium': False, 'name': 'Помощник прокурора (кадровый резерв)',
                                     ...
                                     'published_at': '2024-02-20T09:46:47+0300',
                                     'created_at': '2024-02-20T09:46:47+0300',
                                     'archived': False,
                                     'apply_alternate_url': 'https://hh.ru/applicant/vacancy_response?vacancyId=93513808',
                                     'show_logo_in_search': None, 'insider_interview': None,
                                     'url': 'https://api.hh.ru/vacancies/93513808?host=hh.ru',
                                     'alternate_url': 'https://hh.ru/vacancy/93513808', 'relations': [],
                                     'employer': {'id': '3128277', 'name': 'Прокуратура Республики Крым',
                                                  ...
                                                  'logo_urls': {'240': 'https://img.hhcdn.ru/employer-logo/3430910.png',
                                                                ...
                                                                'original': 'https://img.hhcdn.ru/employer-'
                                                                            'logo-original/747487.png'},
                                                  'vacancies_url': 'https://api.hh.ru/vacancies?employer_id=3128277',
                                                  'accredited_it_employer': False, 'trusted': True},
                                     'snippet': {'requirement': '1) надзор за соблюдением Конституции РФ и исполнением '
                                                                'законов, прав и свобод человека и гражданина. - '
                                                                'наличие высшего юридического образования по...',
                                                 'responsibility': 'Прокуратурой Республики Крым на систематической '
                                                                   'основе проводится отбор кандидатов для постановки '
                                                                   'в кадровый резерв для последующего рассмотрения '
                                                                   'вопроса приема на...'}, 'contacts': None,
                                     'schedule': {'id': 'fullDay', 'name': 'Полный день'}, 'working_days': [],
                                     'working_time_intervals': [], 'working_time_modes': [], 'accept_temporary': False,
                                     'professional_roles': [{'id': '146', 'name': 'Юрист'}],
